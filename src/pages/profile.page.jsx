...
const ProfilePage = () => {
    ...
    const getBlogs = ({page = 1, user_id}) => {
        ...
        axios
            ...
            .then(async ({data}) => {
                let formateDate = await filterPaginationData({
                    state: blogs,
                    data: data.blogs,
                    page,
                ...
                console.log("🚀 ~ .then ~ formateDate:", formateDate);
                ...
                proflie_username.length ? (
                    <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12">
                        <div
                            ...
                            <h1 className="text-2xl font-medium">@{proflie_username}</h1>
